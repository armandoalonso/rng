...
export const id = "piranha305_rng";
export const name = "RNG";
export const version = _version;
export const author = "piranha305";
export const website = "https://piranha305.itch.io/";
export const documentation = "https://www.construct.net";
export const description = "Provides random utilities Actions / Conditions / Expressions for Construct 3, include a Seperate Random Number Generator based on Mersenne Twister";
